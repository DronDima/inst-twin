...
function test() {
  ...
  model.addPhotoPost(addValid);
  model.addPhotoPost(addUnValidId);
  ...
  model.editPhotoPost('2', editValid);
  model.editPhotoPost('2', editUnValidDesc);
}
